...
public class CoachController {
    ...
    public BaseResponse<CoachVo> getCoachByUserId(Long userId) {
    ...
    @Tag(name = "删除教练")
    public BaseResponse<Boolean> deleteCoach(Long id) {
    ...
    @Tag(name = "通过id获取教练信息")
    public BaseResponse<CoachVo> getCoachById(Long id) {
