...
import { getStudentByUserId, updateStudent, uploadStudentAvatar } from '@/api/student'
...
const loading = ref({ userInfo: false, submit: false, password: false, coachAppointments: false, equipmentReservations: false, avatar: false })
...
const handleMenuSelect = (index: string) => { activeMenu.value = index; if (index === 'appointments') loadCoachAppointments() }
